        ...
        while(True):
            ...
            while(i<3):
                ...
                while(True):
                    ...
                    if(('stone' in user_ip) or ('paper' in user_ip) or 
                       ('scissor' in user_ip) or ('papers' in user_ip) 
                       or ('scissors' in user_ip) or 
                       ('cutter' in user_ip) or ('rock' in user_ip)):
                        if(user_ip=='cutter' or user_ip=='scissors'):
                            user_ip='scissor'
                        if(user_ip=='rock' or user_ip=='rocks'):
                            user_ip='stone'
                        if(user_ip=='papers'):
                            user_ip=='paper'
                        break
